...
var crawlerRequest = require('./crawlerRequest');
...
function Crawler(options) {
    ...
    self.onQueue = function(options) {
        crawlerRequest(options);
    };
            ...
            if (useCache(options)) {
                ...
                if (cacheData) {
                    ...
                    if (_.isArray(cacheData)) {
                        self.onContent(null,options,cacheData[0],true);
                    } else {
                        release(options);
                    }
                    return;
